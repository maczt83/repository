...
public class Fish {
    ...
    */
    ...
    public static int[] fishes1A = {4,3,2,1,5};
    public static int[] fishes1B = {0,1,0,0,0};
    
    public static int[] fishes2A = {1,8,3,2,1,7,2,1};
    public static int[] fishes2B = {0,0,1,1,0,0,1,0};
